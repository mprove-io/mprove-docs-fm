...
| format_number                 | string  | ',.0f'  | [Format Number](/docs/reference/format-number). The default d3-format string if no overrides are specified in the fields. |
| currency_prefix               | string  | $       | [Format Number - Symbol](/docs/reference/format-number#symbol). The default d3-format currency prefix.                    |
| currency_suffix               | string  | ''      | [Format Number - Symbol](/docs/reference/format-number#symbol). The default d3-format currency suffix.                    |
