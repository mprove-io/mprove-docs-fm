...
:::info
Mprove project's Remote Repo must be of type **Git Clone** (this option can be specified when creating a new project).
This way you can clone the Remote repo to your Local machine.
