...
| `STORE_FIELDS`                  | storeField []   | -               | [STORE_FIELDS](/docs/ref-model-store#store_fields) - all store parameters and fields in a single array                                           |
...
| `QUERY_SELECTED_DIMENSIONS`     | -               | -               | Dimensions selected by user                                                                                                                               |
| `QUERY_SELECTED_MEASURES`       | -               | -               | Measures selected by user                                                                                                                                 |
| `QUERY_PARAMETERS`              | -               | -               | Filters set by user                                                                                                                                       |
