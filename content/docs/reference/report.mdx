...
`$METRICS_DATE_FROM` and `$METRICS_DATE_TO` are intended for use by [Store Models](/docs/reference/model-store).
...
| parameters   | [Top Filter []](/docs/reference/parameters#top-filter) | -       | Begin a section of report parameters                                      |
| rows         | [Row []](#row)                                   | -       | Begin a section of rows                                                   |
| options      | [Tile Options](/docs/reference/dashboard#tile-options) | -       | Report options schema is the same as dashboard tile options schema        |
...
| fractions  | [Fraction []](/docs/reference/parameters#fraction) | -       | `for parameters mapped to Store` <br/> List of fractions          |
