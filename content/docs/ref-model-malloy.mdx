...
### Malloy Source (mprove) Tags

| Name         | Type       | Default | Description                                                                     |
| ------------ | ---------- | ------- | ------------------------------------------------------------------------------- |
| model        | tag        | -       | If specified, malloy source will be available as mprove Model                   |
| access_roles | string [ ] | -       | If specified, only users with the listed roles will have access to mprove Model |
