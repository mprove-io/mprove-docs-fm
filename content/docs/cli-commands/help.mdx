...
━━━ General commands ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  mprove get-query [--project-id #0] <--repo #0> <--branch #0> <--env #0> [--dashboard-id #0] [--tile-index #0] [--chart-id #0] [--report-id #0] [--row-id #0] [--timezone #0] [--detail #0] [--range #0] [--get-sql] [--get-data] [--json] [--env-file-path #0]
    Get query
