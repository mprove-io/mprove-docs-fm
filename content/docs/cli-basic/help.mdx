...
━━━ General commands ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  mprove get-model [--project-id #0] <--repo-type #0> <--branch #0> <--env #0> <--model-id #0> [--json] [--env-file-path #0]
    Get a model definition including its fields

  mprove get-query [--project-id #0] <--repo-type #0> <--branch #0> <--env #0> [--dashboard-id #0] [--tile-index #0] [--chart-id #0] [--report-id #0] [--row-id #0] [--timezone #0] [--detail #0] [--range #0] [--get-malloy] [--get-sql] [--get-data] [--json] [--env-file-path #0]
    Get query
