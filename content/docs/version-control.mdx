...
When you create a new project, Mprove creates:

- **Production** repository locally on the server that mirrors **Remote** repository content
- Personal **Dev** repository locally on the server for each project member with **FilesEditor** role
