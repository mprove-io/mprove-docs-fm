...
- f\`this year\`        # OR (field >= DATE_TRUNC('year', LOCALTIMESTAMP) AND field < (DATE_TRUNC('year', LOCALTIMESTAMP))+make_interval(years=>(1)::integer))
- f\`this quarter\`     # OR (field >= DATE_TRUNC('quarter', LOCALTIMESTAMP) AND field < (DATE_TRUNC('quarter', LOCALTIMESTAMP))+make_interval(months=>(1*3)::integer))
- f\`this month\`       # OR (field >= DATE_TRUNC('month', LOCALTIMESTAMP) AND field < (DATE_TRUNC('month', LOCALTIMESTAMP))+make_interval(months=>(1)::integer))
- f\`this week\`        # OR (field >= (DATE_TRUNC('week', LOCALTIMESTAMP + INTERVAL '1' DAY) - INTERVAL '1' DAY) AND field < ((DATE_TRUNC('week', LOCALTIMESTAMP + INTERVAL '1' DAY) - INTERVAL '1' DAY))+make_interval(days=>(1*7)::integer))
- f\`this day\`         # OR (field >= DATE_TRUNC('day', LOCALTIMESTAMP) AND field < (DATE_TRUNC('day', LOCALTIMESTAMP))+make_interval(days=>(1)::integer))
- f\`this hour\`        # OR (field >= DATE_TRUNC('hour', LOCALTIMESTAMP) AND field < (DATE_TRUNC('hour', LOCALTIMESTAMP))+make_interval(hours=>(1)::integer))
- f\`this minute\`      # OR (field >= DATE_TRUNC('minute', LOCALTIMESTAMP) AND field < (DATE_TRUNC('minute', LOCALTIMESTAMP))+make_interval(mins=>(1)::integer))

- f\`last year\`        # OR (field >= (DATE_TRUNC('year', LOCALTIMESTAMP))-make_interval(years=>(1)::integer) AND field < DATE_TRUNC('year', LOCALTIMESTAMP))         
- f\`last quarter\`     # OR (field >= (DATE_TRUNC('quarter', LOCALTIMESTAMP))-make_interval(months=>(1*3)::integer) AND field < DATE_TRUNC('quarter', LOCALTIMESTAMP)) 
- f\`last month\`       # OR (field >= (DATE_TRUNC('month', LOCALTIMESTAMP))-make_interval(months=>(1)::integer) AND field < DATE_TRUNC('month', LOCALTIMESTAMP)) 
- f\`last week\`        # OR (field >= ((DATE_TRUNC('week', LOCALTIMESTAMP + INTERVAL '1' DAY) - INTERVAL '1' DAY))-make_interval(days=>(1*7)::integer) AND field < (DATE_TRUNC('week', LOCALTIMESTAMP + INTERVAL '1' DAY) - INTERVAL '1' DAY)) 
- f\`last day\`         # OR (field >= (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>(1)::integer) AND field < DATE_TRUNC('day', LOCALTIMESTAMP)) 
- f\`last hour\`        # OR (field >= (DATE_TRUNC('hour', LOCALTIMESTAMP))-make_interval(hours=>(1)::integer) AND field < DATE_TRUNC('hour', LOCALTIMESTAMP)) 
- f\`last minute\`      # OR (field >= (DATE_TRUNC('minute', LOCALTIMESTAMP))-make_interval(mins=>(1)::integer) AND field < DATE_TRUNC('minute', LOCALTIMESTAMP)) 

- f\`next year\`        # OR (field >= (DATE_TRUNC('year', LOCALTIMESTAMP))+make_interval(years=>(1)::integer) AND field < (DATE_TRUNC('year', LOCALTIMESTAMP))+make_interval(years=>(2)::integer))          
- f\`next quarter\`     # OR (field >= (DATE_TRUNC('quarter', LOCALTIMESTAMP))+make_interval(months=>(1*3)::integer) AND field < (DATE_TRUNC('quarter', LOCALTIMESTAMP))+make_interval(months=>(2*3)::integer)) 
- f\`next month\`       # OR (field >= (DATE_TRUNC('month', LOCALTIMESTAMP))+make_interval(months=>(1)::integer) AND field < (DATE_TRUNC('month', LOCALTIMESTAMP))+make_interval(months=>(2)::integer)) 
- f\`next week\`        # OR (field >= ((DATE_TRUNC('week', LOCALTIMESTAMP + INTERVAL '1' DAY) - INTERVAL '1' DAY))+make_interval(days=>(1*7)::integer) AND field < ((DATE_TRUNC('week', LOCALTIMESTAMP + INTERVAL '1' DAY) - INTERVAL '1' DAY))+make_interval(days=>(2*7)::integer)) 
- f\`next day\`         # OR (field >= (DATE_TRUNC('day', LOCALTIMESTAMP))+make_interval(days=>(1)::integer) AND field < (DATE_TRUNC('day', LOCALTIMESTAMP))+make_interval(days=>(2)::integer)) 
- f\`next hour\`        # OR (field >= (DATE_TRUNC('hour', LOCALTIMESTAMP))+make_interval(hours=>(1)::integer) AND field < (DATE_TRUNC('hour', LOCALTIMESTAMP))+make_interval(hours=>(2)::integer)) 
- f\`next minute\`      # OR (field >= (DATE_TRUNC('minute', LOCALTIMESTAMP))+make_interval(mins=>(1)::integer) AND field < (DATE_TRUNC('minute', LOCALTIMESTAMP))+make_interval(mins=>(2)::integer)) 

- f\`monday\`           # OR (field >= (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-1+6)%7+1)::integer) AND field < (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>(((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-1+6)%7+1)-1)::integer))             
- f\`last monday\`      # OR (field >= (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-1+6)%7+1)::integer) AND field < (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>(((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-1+6)%7+1)-1)::integer))        
- f\`next monday\`      # OR (field >= (DATE_TRUNC('day', LOCALTIMESTAMP))+make_interval(days=>((1-((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)+6)%7+1)::integer) AND field < (DATE_TRUNC('day', LOCALTIMESTAMP))+make_interval(days=>((1-((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)+6)%7+1+1)::integer))        
...
- f\`before tuesday\`     # OR (field < (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-2+6)%7+1)::integer))                
- f\`after tuesday\`      # OR (field >= (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>(((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-2+6)%7+1)-1)::integer))                 
- f\`starting tuesday\`   # OR (field >= (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-2+6)%7+1)::integer))              
- f\`through tuesday\`    # OR (field < (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>(((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-2+6)%7+1)-1)::integer))               

- f\`last monday to next friday\`                   # OR (field >= (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-1+6)%7+1)::integer) AND field < (DATE_TRUNC('day', LOCALTIMESTAMP))+make_interval(days=>((5-((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)+6)%7+1)::integer))                  
...
- f\`not monday\`           # AND (field < (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-1+6)%7+1)::integer) OR field >= (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>(((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-1+6)%7+1)-1)::integer))             
- f\`not last monday\`      # AND (field < (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-1+6)%7+1)::integer) OR field >= (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>(((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-1+6)%7+1)-1)::integer))        
- f\`not next monday\`      # AND (field < (DATE_TRUNC('day', LOCALTIMESTAMP))+make_interval(days=>((1-((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)+6)%7+1)::integer) OR field >= (DATE_TRUNC('day', LOCALTIMESTAMP))+make_interval(days=>((1-((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)+6)%7+1+1)::integer))        
...
- f\`not before tuesday\`   # AND (field >= (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-2+6)%7+1)::integer))                
- f\`not after tuesday\`    # AND (field < (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>(((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-2+6)%7+1)-1)::integer))                 

- f\`not last monday to next friday\`                   # AND (field < (DATE_TRUNC('day', LOCALTIMESTAMP))-make_interval(days=>((((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)-1+6)%7+1)::integer) OR field >= (DATE_TRUNC('day', LOCALTIMESTAMP))+make_interval(days=>((5-((EXTRACT(dow FROM LOCALTIMESTAMP)+1)-1)+6)%7+1)::integer))                  
