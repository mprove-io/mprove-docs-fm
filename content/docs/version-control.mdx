...
- **Git Clone** - Mprove connects to your **Remote** repository (Github recommended)
- **Managed** - Mprove creates a **Remote** repository locally on the server (not recommended as manual access to such a repository is not supported)
