...
- opencode
- [opencode global config](https://github.com/mprove-io/mprove/blob/master/skills/opencode-global-config.json) with [mprove-mcp](/content/mcp/mcp-server-configuration) configured
