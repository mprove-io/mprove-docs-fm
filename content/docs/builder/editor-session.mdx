...
AI agent uses [mprove sync](/docs/mprove-cli/cli-main/sync) CLI command to sync uncommitted changes between sandbox repo and mprove server.
...
- opencode
- [opencode global config](https://github.com/mprove-io/mprove/blob/master/skills/opencode-global-config.json) with [mprove-mcp](docs/builder/mcp-server) configured
- [mprove skills](/docs/builder/skills)
- [mprove cli](/docs/mprove-cli/cli-install) (only "mprove sync" is needed, other useful commands have corresponding mcp tools)
