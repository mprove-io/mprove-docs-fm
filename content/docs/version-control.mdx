...
- Mprove creates **Production** repository locally on the server that mirrors **Remote** repository content
- Mprove creates Personal **Dev** repository locally on the server for each project member with **FilesEditor** role
