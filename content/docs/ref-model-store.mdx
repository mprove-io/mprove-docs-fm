...
These constants are provided based on [Project Config](/docs/ref-project-config#project) and UI control values set by user for a specific query.

| Name                            | Type      | Default         | Description                                                                                                                                               |
| ------------------------------- | --------- | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `PROJECT_CONFIG_CASE_SENSITIVE` | boolean   | -               | Should string filter be case sensitive or not                                                                                                             |
| `METRICS_DATE_FROM`             |           | today's date    | The start date of time range (based on the time filter on the Reports page, otherwise today's date)                                                       |
| `METRICS_DATE_TO`               |           | tomorrow's date | The end date of time range (based on the time filter on the Reports page, otherwise tomorrow's date)                                                      |
| `STORE_FIELDS`                  |           | -               | Store fields definitions                                                                                                                                  |
| `QUERY_ORDER_BY`                |           | -               | Sort order                                                                                                                                                |
| `QUERY_SELECTED_DIMENSIONS`     | string [] | -               | Dimensions selected by user                                                                                                                               |
| `QUERY_SELECTED_MEASURES`       | string [] | -               | Measures selected by user                                                                                                                                 |
