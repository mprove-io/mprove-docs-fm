...
--local-path ~/mprove-demo-mp1 \
--env prod

message:               Sync completed
validationErrorsTotal: 0
url:                   https://app.mprove.io/org/AWNCAHWLFQTQJYCH3ZSE/project/DXYE72ODCP5LWPWH2EXQ/repo/UPXRRK83O347QLFNDX4H/branch/main/env/prod/files
```
