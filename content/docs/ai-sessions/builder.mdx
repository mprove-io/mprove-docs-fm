...
[Editor AI Session](/content/docs/ai-sessions/builder#editor-ai-session) can build mprove models and create non-draft reports, charts and dashboards.
...
- opencode
- [opencode global config](https://github.com/mprove-io/mprove/blob/master/skills/opencode-global-config.json) with [mprove-mcp](/content/mcp/mcp-server) configured
