...
| parameters   | [Top Filter []](/docs/reference/parameters#top-filter) | -       | Begin a section of dashboard parameters                                      |
| tiles\*      | [Tile []](/docs/reference/dashboard#tile)              | -       | Begin a section of tiles                                                     |
...
| fractions  | [Fraction []](/docs/reference/parameters#fraction) | -       | `for parameters mapped to Store Model` <br/> List of fractions            |
