...
For SQL connections, Mprove uses [Malloy](https://www.malloydata.dev/) Sources as resusable data Models.

<Callout>
  In Malloy, the term "Model" usually refers to a file containing Malloy code.
  
  In Mprove, a Model is a specific [Malloy Source](https://docs.malloydata.dev/documentation/language/source).

</Callout>

Malloy has excellent [documentation](https://docs.malloydata.dev/documentation/).

Malloy Sources are reusable. Multiple Sources and Queries can reference the same Source.

To make Malloy Sources visible to Mprove - you need to add the `#(mprove) model` tag.
