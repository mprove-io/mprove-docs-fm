...
To use **Google Analytics** integration create a Store file that references a [Store Preset](/docs/connections#api-store-presets). For custom API data sources (when no preset is available), you need to create a full Store file.
