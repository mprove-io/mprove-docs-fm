...
Any project member has a **Base** role that allow them to:
...
- Save changes to reports, charts and dashboards (only if users are the authors of the original files)
