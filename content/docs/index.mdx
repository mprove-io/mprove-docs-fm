...
With Mprove, instead of directly querying tables, you first need to build data models.

For SQL data sources, see [Malloy Models](/docs/ref-model-malloy). 

For HTTP API data sources, see [Store Models](/docs/ref-model-store).
