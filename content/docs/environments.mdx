...
<Callout type="info" title="Creating additional environments is optional">
  ...
  test environment and run queries against it until the models are ready for
  **prod**.
</Callout>
...
Users can switch between environments in the UI.

## Environment Variables

<Callout type="warn">Environment variables are not implemented yet.</Callout>

If you need environment variables for your use case (e.g. to change table names in models depending on the environment), please let us know on [Github](https://github.com/mprove-io/mprove/issues).
